...
namespace Assets.Scripts.CraftingRecipes.RecipeTypes
{
    ...
    {
        public override List<BlockIdentification> GridLoc1 { get { return new List<BlockIdentification> { BlockIds.AcaciaWood}; } }
        public override List<BlockIdentification> GridLoc2 { get { return new List<BlockIdentification> { BlockIds.AcaciaWood }; } }
