...
{
    public class SeaLanternBlock : Block
    {
        public override string Texture { get { return "Materials/SeaLanternBlock"; } }
        ...
        public SeaLanternBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
