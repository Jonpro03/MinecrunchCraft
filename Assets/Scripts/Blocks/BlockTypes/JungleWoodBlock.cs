...
{
    public class JungleWoodBlock : Block, ILog
    {
        public override string Texture { get { return "Materials/JungleWoodBlock"; } }
        ...
        public JungleWoodBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
