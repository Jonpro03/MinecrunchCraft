...
{
    public class EndStoneBrickBlock : Block
    {
        public override string Texture { get { return "Materials/EndStoneBrickBlock"; } }
        ...
        public EndStoneBrickBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
