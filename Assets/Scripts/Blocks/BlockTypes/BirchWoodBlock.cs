...
{
    public class BirchWoodBlock : Block, ILog
    {
        public override string Texture { get { return "Materials/BirchWoodBlock"; } }
        ...
        public static BlockIdentification BlockId { get { return new BlockIdentification(17, 2); } }
