...
namespace Assets.Scripts.Blocks
{
    ...
    {
        public override string Texture { get { return "Materials/DiamondOreBlock"; } }
        ...
        public static BlockIdentification BlockId { get { return new BlockIdentification(56, 0); } }

        public override BlockCraftingRecipe BlockRecipe { get { return new BlockCraftingRecipe(); } }

        public DiamondOreBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
