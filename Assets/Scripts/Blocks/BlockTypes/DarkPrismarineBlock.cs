...
{
    public class DarkPrismarineBlock : Block
    {
        public override string Texture { get { return "Materials/DarkPrismarineBlock"; } }
        ...
        public DarkPrismarineBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
