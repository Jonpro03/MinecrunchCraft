...
{
    public class MossyStoneBrickBlock : Block
    {
        public override string Texture { get { return "Materials/MossyStoneBrickBlock"; } }
        ...
        public MossyStoneBrickBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
