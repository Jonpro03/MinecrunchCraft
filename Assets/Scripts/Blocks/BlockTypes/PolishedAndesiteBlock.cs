...
{
    public class PolishedAndesiteBlock : Block
    {
        public override string Texture { get { return "Materials/PolishedAndesiteBlock"; } }
        ...
        public PolishedAndesiteBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
