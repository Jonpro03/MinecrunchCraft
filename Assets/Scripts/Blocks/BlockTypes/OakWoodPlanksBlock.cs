...
namespace Assets.Scripts.Blocks
{
    public class OakWoodPlanksBlock : Block, IPlank
    {
        ...
        public static BlockIdentification BlockId { get { return new BlockIdentification(5, 0); } }

        public string Color { get; set; }

        public OakWoodPlanksBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
