...
namespace Assets.Scripts.Blocks
{
    ...
    {
        public override string Texture { get { return "Materials/CobblestoneBlock"; } }
        ...
        public static BlockIdentification BlockId { get { return new BlockIdentification(4, 0); } }

        public override BlockCraftingRecipe BlockRecipe { get { return new BlockCraftingRecipe(); } }

        public CobblestoneBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
