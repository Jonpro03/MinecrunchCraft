...
{
    public class CoalBlockBlock : Block
    {
        public override string Texture { get { return "Materials/CoalBlockBlock"; } }
        ...
        public CoalBlockBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
