...
namespace Assets.Scripts.Blocks
{
    ...
    {
        public override string Texture { get { return "Materials/NetherBrickStairs"; } }
        ...
        public NetherBrickStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
