...
{
    public class AcaciaWoodStairs : Stairs
    {
        public override string Texture { get { return "Materials/AcaciaWoodStairs"; } }
        ...
        public AcaciaWoodStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
