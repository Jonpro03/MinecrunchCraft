...
{
    public class OakWoodStairs : Stairs
    {
        public override string Texture { get { return "Materials/OakWoodStairs"; } }
        ...
        public OakWoodStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
