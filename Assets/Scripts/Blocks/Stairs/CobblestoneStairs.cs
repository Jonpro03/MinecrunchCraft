...
namespace Assets.Scripts.Blocks
{
    ...
    {
        public override string Texture { get { return "Materials/CobblestoneStairs"; } }
        ...
        public CobblestoneStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
