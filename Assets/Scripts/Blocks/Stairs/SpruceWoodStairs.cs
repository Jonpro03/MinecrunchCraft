...
{
    public class SpruceWoodStairs : Stairs
    {
        public override string Texture { get { return "Materials/SpruceWoodStairs"; } }
        ...
        public SpruceWoodStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
