...
{
    public class JungleWoodStairs : Stairs
    {
        public override string Texture { get { return "Materials/JungleWoodStairs"; } }
        ...
        public JungleWoodStairs(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
