...
{
    public class PolishedGraniteBlock : Block
    {
        public override string Texture { get { return "Materials/PolishedGraniteBlock"; } }
        ...
        public PolishedGraniteBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
