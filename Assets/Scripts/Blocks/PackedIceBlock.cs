...
{
    public class PackedIceBlock : Block
    {
        public override string Texture { get { return "Materials/PackedIceBlock"; } }
        ...
        public PackedIceBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
