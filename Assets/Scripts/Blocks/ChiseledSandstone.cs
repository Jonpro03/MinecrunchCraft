...
{
    public class ChiseledSandstoneBlock : Block
    {
        public override string Texture { get { return "Materials/ChiseledSandstoneBlock"; } }
        ...
        public ChiseledSandstoneBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
