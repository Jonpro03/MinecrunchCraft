...
namespace Assets.Scripts.Blocks
{
    ...
    {
        public override string Texture { get { return "Materials/NetherBrickSlabBlock"; } }
        ...
        public NetherBrickSlab(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
