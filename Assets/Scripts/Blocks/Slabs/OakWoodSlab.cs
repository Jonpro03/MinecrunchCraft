...
{
    public class OakWoodSlab : Slab
    {
        public override string Texture { get { return "Materials/OakWoodSlabBlock"; } }
        ...
        public OakWoodSlab(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
