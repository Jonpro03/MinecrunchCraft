...
{
    public class DarkOakWoodSlab : Slab
    {
        public override string Texture { get { return "Materials/DarkOakWoodSlabBlock"; } }
        ...
        public DarkOakWoodSlab(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
