...
{
    public class PolishedDioriteBlock : Block
    {
        public override string Texture { get { return "Materials/PolishedDioriteBlock"; } }
        ...
        public PolishedDioriteBlock(Vector3 chunkPos, Vector2 chunkLoc) : base(chunkPos, chunkLoc)
        {
